...
source(paste0(scrd,"Figure5_Alu_Motif_Target_03_G_AluFreq.R"))

#Panel H
#Figure4 S1
#Frequency in intra-Alu palindromic motif
source(paste0(scrd,"Figure5_Alu_Motif_Target_03_H_MotifDist.R"))
...
source(paste0(scrd,"Figure5_Alu_Motif_Target_S2_MotifFreq.R"))
