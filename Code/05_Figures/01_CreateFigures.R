...
#Prior this code, '00_General.R' code shoul be run to load necesary functions etc

#Figure1 - PDef & sequence logos
source(paste0(scr.wd, "Figure1/Figure1_00_SeqLogo_Main.R"))
...
source(paste0(scr.wd, "Figure2/Figure2_S2_SeqLogo_All.R"))

#Figure3 - Positional nucleotide combinations
source(paste0(scr.wd, "Figure3/Figure3_00_PosComb_Main.R"))

#Figure4 - Characterization of HIV-1 hotspot
source(paste0(scr.wd, "Figure4/Figure4_Alu_Motif_Target_00_Main.R"))
