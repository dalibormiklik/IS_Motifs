...
source(paste0(scrd, "Figure4_Alu_Motif_Target_01_A_RepeatTarget.R"))

#Panel B
#Distribution in Alu consensus
source(paste0(scrd, "Figure4_Alu_Motif_Target_01_B_ConsPos.R"))

#Panel C
#Frequency of sequence motifs in M08_PPM07 component
source(paste0(scrd, "Figure4_Alu_Motif_Target_01_C_CompSeq.R"))
