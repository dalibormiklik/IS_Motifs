...
source(paste0(scrd,"Figure4_Alu_Motif_Target_02_01_GetData.R"))

#Create Panels D, E, F

#Panel D
#Frequency of HIV-1 wt IS in Alu
source(paste0(scrd,"Figure4_Alu_Motif_Target_02_D_AluFreq.R"))

#Panel E
#Frequency of HIV-1 wt IS sequence motifs
source(paste0(scrd,"Figure4_Alu_Motif_Target_02_E_MotifFreq.R"))

#Panel F
#Frequency of HIV wt/N74D IS in Alu
source(paste0(scrd,"Figure4_Alu_Motif_Target_02_F_MotifDistance.R"))
