...
select.smpl <- c(8,2,12,16,14,13,15)
...
source(paste0(scr.wd, "Figure3/Figure3_01_KLID_dinucleotide.R"))

#Create panel 2: positional FREQuencies
source(paste0(scr.wd, "Figure3/Figure3_02_FREQ_dinucleotide.R"))

#Create panel 3: table of frequencies
library(png)
library(grid)
img.2 <- readPNG(paste0(result.wd, "Figures/Figure3_PositionalCombs_table.png"), native = TRUE)
...
source(paste0(scr.wd, "Figure3/Figure3_04_Most-Least_Freq.R"))
...
a4w <- 210
a4h <- 297
ggsave("Figure3_PositionalCombs.png", p.pos.comb,
